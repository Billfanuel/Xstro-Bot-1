...
const { runtime, formatp, tiny } = require('../')
...
function generateMenuText(message, categorizedCommands, theme, input) {
 let menuText = `
${theme.header}
${theme.commandPrefix} *ᴏᴡɴᴇʀ:* ${Config.ownername}
${theme.commandPrefix} *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
${theme.commandPrefix} *ʀᴀᴍ ᴜsᴀɢᴇ:* ${formatp(os.totalmem() - os.freemem())}
${theme.commandPrefix} *ᴛɪᴍᴇ:* ${message.time}
${theme.commandPrefix} *ᴅᴀᴛᴇ:* ${message.date}
${theme.commandPrefix} *ᴄᴏᴍᴍᴀɴᴅs:* ${commands.length}
${theme.footer}                         
*ᴀsᴛᴀ ᴘᴀᴛᴄʜ 𝟸.5.𝟶*
${readmore}`
