...
const acrcloud = require('./fucntions/arc')
const {
 unixTimestampSecond,
 generateMessageTag,
 processTime,
...
const { pg, dbs, groupdb, userdb, alivedb, bot_ } = require(__dirname + '/program')
...
module.exports = {
 ...
 shazam: async function shazam(_0x859a32) {
  ...
  let { code: _0x415c0c, msg: _0x256320 } = _0xf13a35.status
  if (_0x415c0c !== 0) {
   return _0x256320
  }
  let {
  ...
  let { youtube: _0x5a3838, spotify: _0x493522 } = _0x43a980
  return {
   status: 200,
   title: _0x341b8a,
