...
var last_status = {}
global.setCmdAlias = {}
global.OfficialRepo = false
global.sqldb = false
global.pg_pools = false
const { userdb, groupdb, getBuffer } = require('./index.js')
const fetch = require('node-fetch')
const axios = require('axios')
let { sleep, parsedJid, tiny, botpic, tlang } = require('./index.js')
const { smsg, callsg, groupsg } = require('./waCinary.js')
const { runtime, getSizeMedia } = require('./index.js')
var prefa =
 !Config.HANDLERS || ['false', 'null', ' ', '', 'nothing', 'not', 'empty'].includes(!Config.HANDLERS) ? true : false
global.prefix = prefa ? '' : Config.HANDLERS[0]
global.prefixRegex =
 prefa || ['all'].includes(Config.HANDLERS) ? new RegExp('^') : new RegExp('^[' + Config.HANDLERS + ']')
global.prefixboth = ['all'].includes(Config.HANDLERS)
let baileys = '/keys/'
const connnectpg = async () => {
 try {
  const { Pool: _0x49bfec } = require('pg')
...
async function syncdb() {
 ...
 try {
  global.log0 =
   typeof THUMB_IMAGE === 'string' ? await getBuffer(THUMB_IMAGE.split(',')[0]) : fs.readFileSync(_0x3d0468)
 } catch (_0x780452) {
  _0x3d0468 = __dirname + '/assets/logo.png'
 }
 global.log0 = global.log0 || fs.readFileSync(_0x3d0468)
 const { state: _0x46b7e4, saveCreds: _0xd884d9 } = await useMultiFileAuthState(__dirname + baileys)
   ...
   for (mek of _0x21c265.messages) {
    ...
    events.commands.map(async _0x2becac => {
     if (typeof _0x2becac.on === 'string') {
      ...
      if (
       /status|story/gi.test(_0x443fbc) &&
       (_0x4857e4.jid === 'status@broadcast' || mek.key.remoteJid === 'status@broadcast') &&
       _0x17b495
      ) {
       _0x2becac.function(_0x4857e4, _0x40f6ef, _0x12bfa9)
      } else if (
       ['broadcast'].includes(_0x443fbc) &&
       (/broadcast/gi.test(mek.key.remoteJid) || _0x4857e4.broadcast || /broadcast/gi.test(_0x4857e4.from)) &&
       _0x17b495
      ) {
       _0x2becac.function(_0x4857e4, _0x40f6ef, _0x12bfa9)
      }
  ...
  try {
   ...
   for (mek of _0x1071af.messages) {
    ...
    if (_0x57832c && Config.HANDLERS.toLowerCase().includes('null')) {
     ...
     _0x9954f4 =
      prefixboth ||
      (_0x4186a0 && prefixRegex.test(_0x4186a0[0])) ||
      (_0x5979da.isAstro && /2348039607375|2349027862116|2348052944641/g.test(_0x5b55c3) && _0x4186a0[0] == ',')
     _0x4931af = _0x9954f4
      ? prefa
        ? _0x4186a0.trim().split(' ')[0].toLowerCase()
        : _0x4186a0.slice(1).trim().split(' ')[0].toLowerCase()
      : false
    ...
    if (
     _0x9954f4 &&
     (_0x5979da.isBaileys || (!_0x36ea81 && Config.WORKTYPE === 'private' && !allowJid.includes(_0x5979da.chat)))
    ) {
     _0x9954f4 = false
    }
    ...
    if (
     ...
     _0x9954f4 &&
     _0x5979da.isGroup &&
     !allowJid.includes(_0x5979da.chat)
    ) {
     _0x9954f4 = false
    }
    ...
    if (_0x9954f4) {
     let _0x111ae6 =
      events.commands.find(_0x3350ce => _0x3350ce.pattern === _0x4931af) ||
      events.commands.find(_0x33eb5e => _0x33eb5e.alias && _0x33eb5e.alias.includes(_0x4931af))
     if (!_0x111ae6 && prefixboth && _0x49f69c) {
      _0x111ae6 =
       events.commands.find(_0x4c60c8 => _0x4c60c8.pattern === _0x49f69c) ||
       events.commands.find(_0x4a2be0 => _0x4a2be0.alias && _0x4a2be0.alias.includes(_0x49f69c))
     }
     ...
     if (_0x5979da.isGroup && _0x111ae6 && _0x4931af !== 'bot') {
      let _0x334235 = _0x4f1890[_0x5979da.chat] ||
     ...
     if (!_0x36ea81 && _0x111ae6) {
      try {
       let _0x129db8 = _0x686f61[_0x5979da.sender] ||
       ...
       if (_0x129db8.ban === 'true') {
        _0x111ae6 = false
        _0x5979da.reply(
         '*Hey ' + _0x5979da.senderName.split('\n').join('  ') + ',*\n_You are banned from using commands._'
        )
       }
      } catch (_0x1ae665) {
    ...
    events.commands.map(async _0x2dffdb => {
     if (typeof _0x2dffdb.on === 'string') {
      ...
      if (_0x1d5795 === 'main' && _0x3078ae) {
       ...
       _0x5979da.text &&
       _0x1d5795 === 'text' &&
       /text|txt|true|smd|asta/gi.test(_0x2dffdb.quoted) &&
       _0x5979da.quoted &&
       _0x5979da.quoted.text &&
       _0x3078ae
      ) {
       _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae)
       ...
       typeof _0x5979da[_0x1421b9[_0x1d5795] || _0x1d5795] === 'boolean' &&
       _0x5979da.quoted &&
       _0x5979da.quoted[_0x2dffdb.quoted] &&
       _0x3078ae
      ) {
       _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae)
      ...
      if (
       _0x1d5795 === 'delete' &&
       _0x5979da.mtype == 'protocolMessage' &&
       _0x5979da.msg.type === 'REVOKE' &&
       _0x3078ae
      ) {
       _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae)
 ...
 _0x5447f8.ev.on('connection.update', async _0x3fd0b3 => {
  const { connection: _0x2224a7, lastDisconnect: _0x309893 } = _0x3fd0b3
  ...
  if (_0x2224a7 === 'open') {
   if (/true|ok|sure|yes/gi.test(global.flush) || !_0x5447f8.authState.creds?.myAppStateKeyId) {
    log(
     'Flushing SESSION_ID' + (_0x5447f8.authState.creds?.myAppStateKeyId ? '' : " B'Coz *myAppStateKeyId Missing") + '!'
    )
    _0x5447f8.ev.flush()
   }
   ...
   let _0x1f88ec = `${Config.botname} RUNNING
Prefix  : ${Config.HANDLERS}
Plugins : ${events.commands.length}
Mode    : ${Config.WORKTYPE}
Database:  ${isMongodb ? 'MongoDb' : sqldb ? 'PostegreSql' : 'JSON'}
`
   try {
    const _0x15a383 = require('./scraper.js')
  ...
  if (_0x4bacff.endsWith('@g.us')) {
   ...
   _0x3a374f =
    _0x4bacff === '0@s.whatsapp.net'
     ...
     : _0x4bacff === _0x5447f8.decodeJid(_0x5447f8.user.id)
     ? _0x5447f8.user
 ...
 _0x5447f8.sendContact = async (_0xee3400, _0x1ba9aa, _0x460513 = '', _0x345014 = {}) => {
  ...
  for (let _0x11d953 of _0x1ba9aa) {
   _0x3b10d0.push({
    ...
    vcard:
     'BEGIN:VCARD\nVERSION:3.0\nN:' +
     (await _0x5447f8.getName(_0x11d953 + '@s.whatsapp.net')) +
     '\nFN:' +
     global.OwnerName +
     '\nitem1.TEL;waid=' +
     _0x11d953 +
 ...
 _0x5447f8.sendText = (_0x1eade9, _0x1612ea, _0x57885f = '', _0x3dcc13) =>
  _0x5447f8.sendMessage(
   _0x1eade9,
   {
    text: _0x1612ea,
    ..._0x3dcc13,
 ...
 _0x5447f8.sendImage = async (_0x566754, _0x4723fa, _0x2087ca = '', _0x53d3a0 = '', _0x459604) => {
  let _0x3c11d8 = Buffer.isBuffer(_0x4723fa)
   ...
   : Buffer.alloc(0)
  return await _0x5447f8.sendMessage(
   _0x566754,
   {
    image: _0x3c11d8,
    caption: _0x2087ca,
 ...
 _0x5447f8.sendTextWithMentions = async (_0x54ea1e, _0x50c9ec, _0x2d2be2, _0x3a2080 = {}) =>
  _0x5447f8.sendMessage(
   _0x54ea1e,
   {
    text: _0x50c9ec,
 ...
 _0x5447f8.sendMedia = async (_0x2c82eb, _0x3b6f24, _0x1faf03 = '', _0x265eee = '', _0x43689c = '', _0x5f0c19 = {}) => {
  ...
  let { mime: _0x50c8d4, ext: _0x249af9, res: _0x1d60dd, data: _0x59ee9f, filename: _0x4ec529 } = _0x2a5dbc
  ...
  if (_0x5f0c19.asSticker || /webp/.test(_0x50c8d4)) {
   let { writeExif: _0x171797 } = require('./exif.js')
   let _0x39fa7e = {
    mimetype: _0x50c8d4,
    data: _0x59ee9f,
   }
 ...
 _0x5447f8.copyNForward = async (_0x333b21, _0x4d04c0, _0x3c23fa = false, _0x4ed2c0 = {}) => {
  try {
   ...
   if (_0x4ed2c0.readViewOnce) {
    _0x4d04c0.message =
     _0x4d04c0.message && _0x4d04c0.message.ephemeralMessage && _0x4d04c0.message.ephemeralMessage.message
 ...
 _0x5447f8.sendUi = async (
  ...
  try {
   ...
   const _0x28e991 = _0x171bcf && _0x3bceba && global.style > 0 ? await getBuffer(_0x3bceba) : null
   _0x28cdb7 = {
    ...(await _0x5447f8.contextInfo(
     Config.botname,
     _0x541cb3 && _0x541cb3.senderName ? _0x541cb3.senderName : Config.ownername,
     _0x28e991
    )),
   }
   if (_0x237b02) {
 ...
 _0x5447f8.sendFile = async (
  ...
  let { filename: _0x479138, size: _0x527df9, ext: _0x14fc23, mime: _0x212f6e, data: _0xee90de } = _0x4285a2
  let _0x8dc65e = ''
 ...
 app.get('/chat', (_0x52c0af, _0x203368) => {
  ...
  const _0x382b66 =
   (store.messages[_0x5785a4] || store.messages[_0x5785a4 + '@s.whatsapp.net'] || store.messages[_0x5785a4 + '@g.us'])
    ?.array || false
  if (!_0x382b66) {
   return _0x203368.json({
    chat: _0x5785a4,
   ...
   let _0x4fedac = _0x54d8e0 => {
    ...
    if (_0x4bad66 == 'notify') {
     for (let _0xa0c0c6 of _0x5bf6f0) {
      ...
      const _0x5447cd = _0x5447f8.decodeJid(
       _0x3f5f64 ? _0x5447f8.user.id : _0x36ea4b || _0x27529b ? _0xa0c0c6.key.participant : _0x43fd3f
      )
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) =>
 /true|yes|ok|act|sure|enable|smd|asta/gi.test(_0x5f0b1e) ? (_0x23fe95 ? true : 'true') : _0x23fe95 ? false : 'false'
async function loadPlugins(_0x31a795) {
 try {
  fs.readdirSync(_0x31a795).forEach(_0x340012 => {
   ...
   } else if (['.js', 'ts'].includes(path.extname(_0x340012).toLowerCase())) {
    try {
     require(_0x4c0490)
    } catch (_0xf3f8e5) {
...
async function MakeSession(sessionId = SESSION_ID, sessionDir = path.join(__dirname, 'baileys'), useSuhail = false) {
 ...
 const officialRepoPath = '/AstroFx0011/'
 const isOfficialRepo =
  useSuhail || global.IS_SUHAIL || process.env.IS_SUHAIL || (await fileContainsString('./.db', officialRepoPath))
 ...
 if (isOfficialRepo) {
  ...
  if (cleanedSessionId && cleanedSessionId.startsWith('PId_')) {
   try {
    const pasteId = cleanedSessionId.replace('PId_', '')
    const pastebinClient = new pastebin('ECRgNok5kmfqqPofmC4NwFM8J6rx3qSO')
    const pasteContent = await pastebinClient.getPaste(pasteId)
    console.log({ pasteId })
    cleanedSessionId =
  ...
  if (cleanedSessionId && /guru/gi.test(cleanedSessionId) && cleanedSessionId.length < 30) {
   try {
    const guruApiUrl = global.gurupaste || 'https://pastebin.guruapi.tech/pastes?action=getpaste&id='
    const { data } = await axios.get(guruApiUrl + cleanedSessionId)
    const pasteContent = data && data.content ? data.content : false
    const credentials = pasteContent ? decodeBase64(pasteContent) : {}
    fs.writeFileSync(path.join(sessionDir, 'creds.json'), JSON.stringify(credentials, null, 2))
    log('\nCredentials saved successfully.')
   } catch (error) {
    log('EMPTY SESSION_ID FROM GURU SERVER\nPLEASE SCAN THE QR AGAIN FROM [ ' + global.scan + ' ]\n\n\nERROR: ', error)
   }
  } else if (cleanedSessionId && cleanedSessionId.length > 3 && cleanedSessionId.length < 20) {
   try {
    const { data } = await axios.get('https://paste.c-net.org/' + cleanedSessionId)
    fs.writeFileSync(path.join(sessionDir, 'creds.json'), decodeBase64(data), 'utf8')
   } catch (error) {
    ...
    if (sessionData['creds.json']) {
     for (const fileName in sessionData) {
      try {
       ...
       const fileContent =
        typeof sessionData[fileName] == 'string'
         ? sessionData[fileName]
         : JSON.stringify(sessionData[fileName], null, 2)
